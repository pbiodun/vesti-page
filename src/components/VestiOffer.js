      ...
      <div className="container flex flex-col justify-center items-center">
        ...
        <div className="grid lg:grid-cols-3 gap-12 py-12 items-center justify-between">
          ...
          <div className="flex">
            ...
            <div className="px-5">
              <h1 className="text-headcol text-lg font-semibold">{head4}</h1>
              <p className="text-[#2B5219] font-extralight text-sm">{desc4}</p>
            </div>
          </div>
          <div className="flex">
            <div>
            ...
            <div className="px-5">
              <h1 className="text-headcol text-lg font-semibold">{head5}</h1>
              <p className="text-[#2B5219] font-extralight text-sm">{desc5}</p>
            </div>
          </div>
          <div className="flex">
            <div>
            ...
            <div className="px-5">
              <h1 className="text-headcol text-lg font-semibold">{head6}</h1>
              <p className="text-[#2B5219] font-extralight text-sm">{desc6}</p>
            </div>
          </div>
        </div>
