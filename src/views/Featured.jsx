...
const Featured = () => {
  return (
    <div className="w-full bg-[#F9F8F9]">
      <div className="container mx-auto flex flex-col lg:flex-row lg:justify-between items-center py-11">
        <div className="sm:pb-10 md:pb-10 lg:pb-0">
          <p className="text-2xl font-semibold">As featured in</p>
        </div>
        <div className="flex flex-wrap justify-center opacity-50">
          <img className="" src={Techstars} alt="techstars" />
          <img className="px-8" src={Techcity} alt="techcity" />
